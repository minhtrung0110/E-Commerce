        ...
        <div class="card-body card-add row col-md-10 mb-sm-4 ml-sm-5">
            ...
            <form method="post" action="" id="form-add-sliders" class="row" enctype="multipart/form-data">
                ...
                <div class="form-group col-sm-10">
                    ...
                    <input type="file" name="thumb" onchange="ImagesFileAsURL('thumb','displayImg');" id='thumb'
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // chưa fix dc xung dột giữa lib validate với ajax upload file
        /*   Validator({
        ...
        $('#form-add-sliders').submit(function(e) {
            e.preventDefault();
                ...
                success: (response) => {
                    if (response) {
                        ...
                        if (response.error === false) {
                            swal("Thêm Thành Công", "Chủ Đề Đã Được Thêm", "success");
                            setTimeout(() => {
                                window.location = "/admin/sliders/list"
                            }, 1200);
                        } else {
                            swal("Thêm Thất Bại", "Thêm Chủ Đề Và Ảnh Thất Bại", "error");
