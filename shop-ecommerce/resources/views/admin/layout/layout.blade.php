...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('/template/images/icon_brand.png')}}" alt="Trésor Du Ciel" height="60" width="60">
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="" class="nav-link">Quản Lý {{$title}}</a>
      </li>
       {{--
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/admin/" class="brand-link">
      <img src="{{asset('/template/images/icon_brand.png')}}" alt="Trésor du ciel Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Trésor Du Ciel</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('/template/images/icon_brand.png')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
