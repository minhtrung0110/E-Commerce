        ...
        <div class="row">
                    ...
                    <div class="wrap-table-shopping-cart">
                        ...
                        <table class="table-shopping-cart">
                            ...
                            <tr class="table_row">
                                ...
                                <td class="column-2">  <a href="/detail-product/{{$product->id}}-{{\Str::slug($product->name_product,'-')}}.html" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">{{$product->name_product}}</td>
            ...
            <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                    ...
                    <button class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer " id="btn-order">
                        Thanh Toán
                    </button>
                </div>
            </div>
